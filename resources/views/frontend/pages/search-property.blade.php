            ...
            <div class="row rent_main">
                <div class="col-lg-4">
                    <div class="search_bar">
                        ...
                        <div class="accordion_part mt-3">
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item border-bottom-success">
                            ...
                            Location
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Dhaka<input type="radio" name="categorie" id="categorie1"></li>
                                                <li>Chittagong<input type="radio" name="categorie" id="categorie2"></li>
                                                <li>Shylet<input type="radio" name="categorie" id="categorie3"></li>
                                                <li>Barisal<input type="radio" name="categorie" id="categorie4"></li>
                                                <li>Khulna<input type="radio" name="categorie" id="categorie5"></li>
                                                <li>Rangpur<input type="radio" name="categorie" id="categorie6"></li>
                                                <li>Mymonsing<input type="radio" name="categorie" id="categorie7"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            Property Type
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Apartment<input type="radio" name="categorie" id="categorie1"></li>
                                                <li>Condos<input type="radio" name="categorie" id="categorie2"></li>
                                                <li>Dever<input type="radio" name="categorie" id="categorie3"></li>
                                                <li>House<input type="radio" name="categorie" id="categorie4"></li>
                                                <li>Offices<input type="radio" name="categorie" id="categorie5"></li>
                                                <li>Rental<input type="radio" name="categorie" id="categorie6"></li>
                                                <li>Studios<input type="radio" name="categorie" id="categorie7"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            Property Status
                                    ...
                                    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Buy<input type="radio" name="categorie" id="categorie1"></li>
                                                <li>Rent<input type="radio" name="categorie" id="categorie2"></li>
                                                <li>Sale<input type="radio" name="categorie" id="categorie3"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            Features
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Air Conditions<input type="radio" name="categorie" id="categorie1"></li>
                                                <li>Fire Alarm<input type="radio" name="categorie" id="categorie2"></li>
                                                <li>Car Parking<input type="radio" name="categorie" id="categorie3"></li>
                                                <li>Central Heater<input type="radio" name="categorie" id="categorie4"></li>
                                                <li>Free Wifi<input type="radio" name="categorie" id="categorie5"></li>
                                                <li>Gym<input type="radio" name="categorie" id="categorie6"></li>
                                                <li>Swiming Pool<input type="radio" name="categorie" id="categorie7"></li>
                                                <li>Window Covering<input type="radio" name="categorie" id="categorie7"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            Price
                                    ...
                                    <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>1000000-2000000<input type="radio" name="categorie" id="categorie1"></li>
                                                <li>2000000-3000000<input type="radio" name="categorie" id="categorie2"></li>
                                                <li>3000000-4000000<input type="radio" name="categorie" id="categorie3"></li>
                                                <li>4000000-5000000<input type="radio" name="categorie" id="categorie4"></li>
                                                <li>5000000-6000000+<input type="radio" name="categorie" id="categorie5"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            Beds
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Bed 1<input type="radio" name="categorie" id="categorie1"></li>
                                                <li>Bed 2<input type="radio" name="categorie" id="categorie2"></li>
                                                <li>Bed 3<input type="radio" name="categorie" id="categorie3"></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            Baths
                                    ...
                                    <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <ul>
                                                <li>Bath 1<input type="radio" name="categorie" id="categorie1"></li>
                                                <li>Bath 2<input type="radio" name="categorie" id="categorie2"></li>
                                                <li>Bath 3<input type="radio" name="categorie" id="categorie3"></li>
                ...
                <div class="col-lg-8 px-0">
                    <div class="row mx-0">
                        <div class="col-lg-12">
                            <div class="search_rlst_main">
                                <div class="search_rslt_head">
                                    <h4>Showing 1-10 of 18 results</h4>
                                </div>
                                <div class="search_rslt_icon">
                                    <div class="option">
                                        <select name="" id="">
                    ...
                    <div class="row mx-0" id="search_3">
                        <div class="col-lg-12">
                            <div class="rent_item d-md-flex d-lg-flex d-xl-flex d-xxl-flex">
                                <div class="rent_img">
                                    <img src="images/search_3.jpg" alt="img" class="img-fluid w-100 h-100">
                                </div>
                                ...
                                </svg> Road No-10 , Mirpur 01, Dhaka, Bangladesh
                                    </h5>
                                    <div class="bed-main">
                                        <div class="bed_item">
