    ...
    <div class="layout-width">
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none" id="page-header-cart-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="/assets/images/products/img-1.png" class="me-3 rounded-circle avatar-sm p-2 bg-light shadow" alt="user-pic">
                                        <div class="flex-1">
                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="/assets/images/products/img-2.png" class="me-3 rounded-circle avatar-sm p-2 bg-light shadow" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="/assets/images/products/img-3.png" class="me-3 rounded-circle avatar-sm p-2 bg-light shadow" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="/assets/images/products/img-6.png" class="me-3 rounded-circle avatar-sm p-2 bg-light shadow" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="/assets/images/products/img-5.png" class="me-3 rounded-circle avatar-sm p-2 bg-light shadow" alt="user-pic">
                                        <div class="flex-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                        ...
                        <div class="tab-content" id="notificationItemsTabContent">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="/assets/images/users/avatar-2.jpg" class="me-3 rounded-circle avatar-xs shadow" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item position-relative">
                                        <div class="d-flex">
                                            <img src="/assets/images/users/avatar-8.jpg" class="me-3 rounded-circle avatar-xs shadow" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                            ...
                            <div class="tab-pane fade py-2 ps-2" id="messages-tab" role="tabpanel" aria-labelledby="messages-tab">
                                <div data-simplebar style="max-height: 300px;" class="pe-2">
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <img src="/assets/images/users/avatar-3.jpg" class="me-3 rounded-circle avatar-xs shadow" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                                    ...
                                    <div class="text-reset notification-item d-block dropdown-item">
                                        <div class="d-flex">
                                            <img src="/assets/images/users/avatar-6.jpg" class="me-3 rounded-circle avatar-xs shadow" alt="user-pic">
                                            <div class="flex-1">
                                                <a href="#!" class="stretched-link">
                ...
                <span class="d-flex align-items-center">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome Mahadi!</h6>
                        ...
                        <a class="dropdown-item" href="{{route('admin.logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
